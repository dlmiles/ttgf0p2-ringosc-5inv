# SPDX-FileCopyrightText: © 2025 Darryl L. Miles
...
async def test_project(dut):
    ...
    dut.uio_in.value = 0
    dut.rst_n.value = 0
    await Timer(40, unit='us') # show quiscent

    dut._log.info("Enable")
    dut.ena.value = 1
    await Timer(40, unit='us') # show ringosc disabled
